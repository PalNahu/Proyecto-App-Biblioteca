...
export const Principal = () => {
    return (
        <>
            ...
            <div className="flex flex-row justify-center gap-5 mt-20 mb-28">
                <div className="basis-1/7 flex flex-col justify-between w-64">
                    <div className='p-1'>
                        <div className='title-principal-content'>
                            Best Selling Plants
                        </div>
                        <div className='subtitle-principal-content'>
            ...
            <div className='flex flex-col item-center mt-32 mb-24'>
                <div className='mb-8'>
            ...
            <div className='flex flex-col item-center mt-32'>
                <div className='mb-12'>
