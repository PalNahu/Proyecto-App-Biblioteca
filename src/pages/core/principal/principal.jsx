                ...
                <div className="basis-2/7 dark:text-white">
                    <Card className="col-span-12 sm:col-span-4 h-[300px]">
                        <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                            ...
                            <h4 className="text-white font-medium text-large">Amplía tus conocimientos tecnológicos</h4>
                        </CardHeader>
                        <Image
                            removeWrapper
                            alt="Card background"
                ...
                <div className="basis-2/7">
                    <Card className="col-span-12 sm:col-span-4 h-[300px]">
                        <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                            ...
                            <h4 className="text-red font-medium text-large ">Ven y lee un poco de historia.</h4>
                        </CardHeader>
                        <Image
                            removeWrapper
                            alt="Card background"
                ...
                <div className="basis-2/7">
                    <Card className="col-span-12 sm:col-span-4 h-[300px]">
                        <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                            ...
                            <h4 className="text-white font-medium text-large">Maneja tus finanzas</h4>
                        </CardHeader>
                        <Image
                            removeWrapper
                            alt="Card background"
